...
public class Habitat implements Serializable {
    ...
    public Habitat(String nomedobioma, int capacidade, String tipo, int idHabitat) {
    ...
    public void adicionarAnimal(Animal animal) {
        if (animais.size() < capacidade) {
            if (animal.bioma.equals(nomedobioma) || tipo.equals("misto")) {
                animais.add(animal);
                System.out.println("Animal " + animal.nome + " adicionado no habitat " + idHabitat);
            } else {
                System.out.println("Bioma do animal nao e compativel com o habitat " + idHabitat);
            }
        } else {
