...
public class Animal implements Serializable {
    ...
    public Animal(String nome, String especie, int id, String bioma, int idade, int fome)throws IdadeInvalidaException {
      if (idade < 0) {
        throw new IdadeInvalidaException("a idade nao pode ser menor que zero");
    }  
